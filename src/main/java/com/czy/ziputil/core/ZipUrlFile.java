...
import com.czy.ziputil.unzip.UnzipUrl;
...
public class ZipUrlFile {
	 ...
	 * @throws ZipException
	 */
	public ZipUrlFile(String zipUrlFile) throws Exception {
		this(new UrlFile(zipUrlFile));
	}
	 ...
	 * @throws ZipException
	 */
	public ZipUrlFile(UrlFile zipFile) throws Exception {
		if (zipFile == null) {
	...
	private void readZipInfo() throws ZipException {
		...
		RandomAccessUrlFile raf = null;
		try {
			if (zipModel == null) {
				raf = new RandomAccessUrlFile(new UrlFile(file));
	...
	public ZipInputStream getInputStream(FileHeader fileHeader) throws ZipException {
		...
		UnzipUrl unzip = new UnzipUrl(zipModel);
